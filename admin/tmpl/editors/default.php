...
/** @var \Nickpsal\Component\BooksList\Administrator\View\Editors\HtmlView $this */
...
?>
<form action="<?php echo Route::_('index.php?option=com_books_list&view=editors'); ?>" method="post" name="adminForm" id="adminForm">
	<div class="row">
		<div class="col-md-12">
					...
					<table class="table">
						<thead>
							<tr>
								...
								<th><?php echo HTMLHelper::_('searchtools.sort', 'COM_BOOKS_LIST_FIELD_EDITOR_NAME_LABEL', 'a.name', $listDirn, $listOrder); ?></th>
						...
						<?php foreach ($this->items as $i => $item) : ?>
							<tr class="row<?php echo $i % 2; ?>">
								...
								<td class="text-center"><?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'editors.', true); ?></td>
								<th scope="row">
									<a href="<?php echo Route::_('index.php?option=com_books_list&task=editor.edit&id=' . (int) $item->id); ?>">
